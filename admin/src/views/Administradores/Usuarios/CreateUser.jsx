...
import userService from "../../../services/user"; // Import user service
...
const CreateUser = () => {
  ...
  const [birthDate, setBirthDate] = useState(""); // Assuming date input type
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setPassword("");
      setRole("");
      navigate("/Administrar/Usuarios"); // Redirect on success
    } catch (error) {
    ...
    <div className="d-flex flex-column align-items-start p-4 container-fluid">
      ...
      >
        ...
        <label className="d-flex flex-column form-label w-50">
          Fecha de nacimiento
          <input
            type="date" // Assuming date input type
            value={birthDate}
