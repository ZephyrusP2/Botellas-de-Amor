  ...
  return (
    <div className="col col-auto col-md-3 col-xl-2 px-sm-2 px-0 side-bar">
      <div className="sidebar-container d-flex flex-column align-items-center justify-content-center px-3 pt-2 text-white min-vh-100 position-relative">
        <div>
          <a
            href="/operador/registrar-botellas"
            className={`text-container d-flex  pb-3 align-items-center me-xl-auto text-white text-decoration-none ${currentPath.includes("/operador/registrar-botellas") ? "active" : ""}`}
          >
            <svg
              width="41"
              height="39"
        ...
        >
          <a
            href="/"
            className="d-flex align-items-center pb-3 mb-md-0 me-xl-auto text-white text-decoration-none"
          >
            <svg
              width="32"
              height="32"
