            ...
            <View style={styles.card}>
              <View style={styles.content}>
                ...
                <View style={styles.imageContainer}>
                  <Image
                    source={require("../images/botella.png")}
                    style={[
                      styles.image,
                      { height: 130, width: 100, marginLeft: 50 },
                    ]}
                  />
                </View>
                <View style={styles.itemContainer}>
                  <Image
                    source={require("../images/bolsa.png")}
                    style={[styles.image, { height: 130, width: 90 }]}
                  />
                  <View style={styles.textContainer}>
                    <Text style={[styles.subtitle, sharedClasses.textBlue]}>
                      BOLSAS
                    </Text>
                    <Text style={sharedClasses.textZinc}>
                      de todo tipo: Arroz, pasta, galletas, cereales, bolsa del
                      mercado, salsa, leche, carnes, yogurt...
                    </Text>
                  </View>
                </View>
                <View style={styles.item}>
                  <Text style={[styles.subtitle, sharedClasses.textRed]}>
                    RECUERDA
                  </Text>
                  <Text style={sharedClasses.textZinc}>
          ...
          <View style={styles.p4}>
            <View style={styles.card}>
              <View style={styles.content}>
                ...
                <View style={styles.itemContainer}>
                  <Image
                    source={require("../images/empaque.png")}
                    style={[styles.image, { height: 130, width: 90 }]}
                  />
                  <View style={styles.textContainer}>
                    <Text style={[styles.subtitle, sharedClasses.textBlue]}>
                    ...
                    <Text style={sharedClasses.textZinc}>
                      de golosinas y snacks: Papas, helados, chocolates,
                      galletas, bombones, dulces, frutos secos...
                    </Text>
                  </View>
                </View>
                <View style={styles.item}>
          ...
          <View style={styles.p4}>
            <View style={styles.card}>
              <View style={styles.content}>
                ...
                <View style={styles.itemContainer}>
                  <Image
                    source={require("../images/elementos.png")}
                    style={[styles.image, { height: 130, width: 90 }]}
                  />
                  <View style={styles.textContainer}>
                    <Text style={[styles.subtitle, sharedClasses.textBlue]}>
                    ...
                    <Text style={sharedClasses.textZinc}>
                      desechables plásticos: Mezcladores, pitillos, vasos, tubos
                      de cremas, cubiertos, cepillos de dientes...
                    </Text>
                  </View>
                </View>
                <View style={styles.item}>
