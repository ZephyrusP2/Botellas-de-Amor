        ...
        <View style={styles.cardContainer}>
          <View style={styles.p4}>
            <Text
              style={[
                styles.subtitle,
                { color: "#0AB5B8", textAlign: "center" },
              ]}
            >
              SOMOS BOTELLAS DE AMOR
            </Text>
            ...
            >
              CÓMO NACE BOTELLAS DE AMOR {"\n"}
              <Text style={{ color: "#FD595A" }}>
            ...
            <Image
              source={require("../images/ecoladrillos.png")}
              style={styles.image2}
            />
            <Text style={styles.text}>
            ...
            <Image
              source={require("../images/ecoladrillos2.png")}
              style={styles.image2}
            />
            <Text style={styles.text}>
